...
if __name__ == "__main__":
	...
	writer = SummaryWriter(logdir="./kinova_gripper_strategy/{}_{}/".format(args.policy, args.tensorboardindex))
	...
	for t in range(int(args.max_timesteps)):
		...
		if t >= args.start_timesteps:
			...
			actor_loss, critic_loss, critic_L1loss, critic_LNloss = policy.train(replay_buffer, args.batch_size)
