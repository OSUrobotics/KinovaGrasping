...
def generate_object_coordinates(num_points,shape_name,orient_name):
    ...
    graspable_regions = {"normal": [-0.09,0.09,-0.01,0.04],"rotated": [-0.06, 0.06,-0.06, 0.03],"top": [-0.06, 0.06,-0.09, 0.09]} # x_min, x_max, y_min, y_max
...
if __name__ == "__main__":
    ...
    orient_names= ["rotated"]#["normal","rotated","top"]
    with_noise = True
