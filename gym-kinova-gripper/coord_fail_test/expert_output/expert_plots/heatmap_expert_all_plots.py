...
def create_plots(success_datax,success_datay,fail_datax,fail_datay,total_datax,total_datay):
    ...
    freq_plot_title = "Grasp Trial Frequency per Initial Pose of Object ("+shapes+") - Expert PID Controller"
    heatmap_freq(total_datax,total_datay,freq_plot_title,'freq_heatmap_.jpg')

    fail_plot_title = "Grasp Trial Success Rate per Initial Pose of Object ("+shapes+") - Expert PID Controller"
    ...
    success_plot_title = "Grasp Trial Success Rate per Initial Pose of Object ("+shapes+") - Expert PID Controller"
